...
namespace Game.Visuals
{
    internal class MazeVisuals
    {
        ...
        internal void PrintMaze(GameModel gameModel, int remainingMoves)
        {
           ...
           AnsiConsole.Markup("[lightyellow3]"+players[gameModel.GetCurrentTurn()%players.Count].ToString()+"[/]");
           System.Console.WriteLine();
           AnsiConsole.Markup($"[lightyellow3]Cantidad de movimientos restantes {remainingMoves}[/]");
